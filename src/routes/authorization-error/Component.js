  ...
  render () {
    return (
      <div className='authorization-error'>
        ...
        <h2>Maybe because SSL certification has expired. Navigate to <a href='https://mockapi.pizza.de/v1/auth' target='_blank' rel='noopener noreferrel'>https://mockapi.pizza.de/v1/auth</a> and allow access to this URL then click <button className='btn btn-primary btn-lg' type='button' onClick={this.handleReload}>Reload</button>.
        </h2>
      </div>
    )
  }
